...
public class BoardRepositoryTests {
	 ...
	 * 
	 * Page<WebBoard> result = repo.findAll(repo.makePredicate(null, null),
	 * pageable);
	 * 
	 ...
	 * Pageable pageable = PageRequest.of(0, 20, Direction.DESC, "bno");
	 * 
	 * Page<WebBoard> result = repo.findAll(repo.makePredicate("t", "10"),
	 * pageable);
	 * 
	 * log.info("PAGE: " + result.getPageable());
	 * 
	 * log.info("----------------------"); result.getContent().forEach(board ->
	 * log.info("" + board));
	 * 
	 * }
	 * 
	 ...
	 * 
	 * //3 page , size = 20 Pageable pageable = PageRequest.of(29, 10,
	 * Direction.DESC, "bno");
	 * 
	 * Page<WebBoard> result = repo.findAll(repo.makePredicate(null, null),
	 * pageable);
