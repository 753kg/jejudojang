...
public class ItineraryBoardRepliesController {
	...
	@Transactional
	@PostMapping("/{bno}")
	public ResponseEntity<List<ItineraryBoardRepliesVO>> addReply(
			@PathVariable("bno")Long bno, 
			@RequestBody ItineraryBoardRepliesVO reply){
	...
	public ResponseEntity<List<ItineraryBoardRepliesVO>> remove(
			@PathVariable("bno")Long bno,
		...
		return  new ResponseEntity<>(getListByItineraryBoard(board), HttpStatus.OK);
	...
	@Transactional
	@PutMapping("/{bno}")
	public ResponseEntity<List<ItineraryBoardRepliesVO>> modify(@PathVariable("bno")Long bno, 
			@RequestBody ItineraryBoardRepliesVO reply){
	...
	@GetMapping("/{bno}")
	public ResponseEntity<List<ItineraryBoardRepliesVO>> getReplies(
			@PathVariable("bno")Long bno){
